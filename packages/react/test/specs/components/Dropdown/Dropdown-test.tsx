...
describe('Dropdown', () => {
  ...
  describe('value', () => {
    ...
    it('has onSelectedChange called when item is added', () => {
      const itemToClickIndex = 2
      const onSelectedChange = jest.fn()
      const { clickOnItemAtIndex } = renderDropdown({ open: true, onSelectedChange })
    ...
    it('has onValueChanged called when item is added or removed on multiple', () => {
